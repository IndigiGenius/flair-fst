...
from ..iterators import MutableTrsIterator, StateIterator
from ..tr import Tr
from ..weight import weight_one
...
if TYPE_CHECKING:
    from ..algorithms.compose import ComposeConfig
    from ..algorithms.determinize import DeterminizeConfig
    from ..algorithms.minimize import MinimizeConfig
    from ..algorithms.project import ProjectType
    from ..algorithms.shortest_path import ShortestPathConfig
...
class VectorFst(Fst):
    ...
    def compose(
        ...
        from ..algorithms.compose import compose, compose_with_config
    ...
    def determinize(
        ...
        Returns:
            The resulting Fst.
        """
        from ..algorithms.determinize import determinize, determinize_with_config
    ...
    def minimize(self, config: Union["MinimizeConfig", None] = None) -> "VectorFst":
        ...
        Returns:
          self
        """
        from ..algorithms.minimize import minimize, minimize_with_config
    ...
    def project(self, proj_type: Union["ProjectType", None] = None) -> "VectorFst":
        ...
        Returns:
            self
        """
        from ..algorithms.project import project, ProjectType  # noqa: W0621
    ...
    def replace(
        ...
        """
        from ..algorithms.replace import replace
    ...
    def rm_epsilon(self) -> "VectorFst":
        ...
        """
        from ..algorithms.rm_epsilon import rm_epsilon
    ...
    def union(self, other_fst: "VectorFst") -> "VectorFst":
        ...
        """
        from ..algorithms.union import union
    ...
    def optimize_in_log(self) -> "VectorFst":
        ...
        Returns:
          self
        """
        from ..algorithms.optimize import optimize_in_log
    ...
    def tr_sort(self, ilabel_cmp: bool = True) -> "VectorFst":
        ...
        Returns:
          self
        """
        from ..algorithms.tr_sort import tr_sort
    ...
    def tr_unique(self) -> "VectorFst":
        ...
        Returns:
          self
        """
        from ..algorithms.tr_unique import tr_unique
    ...
    def isomorphic(self, other: "VectorFst") -> bool:
        ...
        """
        from ..algorithms.isomorphic import isomorphic
    ...
    def invert(self) -> "VectorFst":
        ...
        Returns:
           self
        """
        from ..algorithms.inversion import invert
